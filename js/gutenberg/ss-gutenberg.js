            ...
            <>
                ...
                <InspectorControls>
                    <PanelBody
                        ...
                        initialOpen={true}
                    >
                        <p><a href="https://podpora.redbit.cz/stitek/wp-plugin/">{__('Help - SimpleShop plugin','ss')}</a></p>
                        <SelectControl
                            label={__('Group', 'ss')}
                        ...
                        />
                        <ToggleControl
                            label={__('Ignore date limits', 'ss')}
                            help={__('Check to completely disable limiting post access by date', 'ss')}
